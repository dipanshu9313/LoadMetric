...
class LoadTimeChecker:
    ...
    def get_load_time(self):
        ...
        finaldf = finaldf.loc[:, ['Measure', 'DimensionName', 'ColumnName',
                                  'LoadTime', 'isMeasureUsedInVisual','ReportName', 'PageName', 'VisualName', 'Query','hasDimension']]
...
def get_data():
    ...
    # connection_string = "Provider=MSOLAP.8;Integrated Security=SSPI;Persist Security Info=True;Initial Catalog=ed32a00b-94d3-42b0-a78b-440ebfd91b5f;Data Source=localhost:54959;MDX Compatibility=1;Safety Options=2;MDX Missing Member Mode=Error;Update Isolation Level=2"
    checkforlocal = 'n'
    connection_string = ''
    # connection_string = 'Provider=MSOLAP.8;Integrated Security=SSPI;Persist Security Info=True;Initial Catalog=f85b581f-49e9-49e8-9538-464211a32e0f;Data Source=localhost:61683;MDX Compatibility=1;Safety Options=2;MDX Missing Member Mode=Error;Update Isolation Level=2'
    print(data)
